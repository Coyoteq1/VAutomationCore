    ...
    public static class ConsoleRoleAuthService
    {
        ...
        private static void LoadOrCreateConfig()
        {
            ...
            catch (Exception ex)
            {
                ...
                Log.LogWarning($"[ConsoleRoleAuth] Failed to load config: {ex}");
            }
        }
        ...
        private static void TryApplyRoleComponent(ulong subjectId, ConsoleRole role, DateTime expiresAtUtc)
        {
            ...
            {
                Log.LogDebug($"[ConsoleRoleAuth] Failed to apply role component: {ex}");
            }
        }
        ...
        private static void TryClearRoleComponent(ulong subjectId)
        {
            ...
            {
                Log.LogDebug($"[ConsoleRoleAuth] Failed to clear role component: {ex}");
            }
        }
