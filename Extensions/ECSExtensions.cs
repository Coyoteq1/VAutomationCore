...
namespace VAuto.Extensions
{
    ...
    public static class ECSExtensions
    {
        ...
        public static T Read<T>(this Entity entity, EntityManager em) where T : struct
        {
            ...
            {
                Plugin.Log.LogError($"[ECSExtensions] Error reading component {typeof(T).Name} from entity {entity}: {ex}");
            }
            return default;
        }
        ...
        public static void Write<T>(this Entity entity, EntityManager em, T component) where T : struct
        {
            ...
            {
                Plugin.Log.LogError($"[ECSExtensions] Error writing component {typeof(T).Name} to entity {entity}: {ex}");
            }
        }
